...
export const GraphTableCreator = (props) => {
  return (
    <table style={{border: "1px solid black",  textAlign:"center"}}>
     <thead>
        <tr>
          <th style={{borderBottom: "1px solid black", backgroundColor:"#FF8A65", color: "white", textAlign:"center", padding: 15, width:200}}>{props.tableHeadingKey}</th>
    ...
    <tbody>
      <tr>
        <td style={{ textAlign:"center", padding: 15, width:200, backgroundColor: index % 2 === 0 ? 'white' : '#FFCCBC'}}>{el.x.split('_').join(' ')}</td>
